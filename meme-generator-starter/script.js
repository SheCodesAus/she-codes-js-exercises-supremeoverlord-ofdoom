function getImage() {
    ...
    //create an image element and give it the id "meme-image"
    // append it to "meme-image-wrapper"
    ...
    document.getElementById("meme-builder").style.display = "block"; //editing the css directly here with javascript
}
function addTopText() {
